...
title: "性分化障碍: 性别无关于染色体"
linkTitle: "Chromosomes"
description: "DNA 更像是被你称为指导的东西, 而非绝对的规则."
preBody: '_disclaimer'
classes:
  - gdb
siblings:
...
- [雄激素不敏感综合征](https://en.wikipedia.org/wiki/Androgen_insensitivity_syndrome)（AIS）：对雄激素部分或完全拮抗，导致XY染色体组的孩子睾丸外的所有器官都不会男性化。AIS患者常常建立女性性别认同，但部分案例为男性认同。
